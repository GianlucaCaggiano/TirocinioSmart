...
public class ProgettoFormativo {
   ...
   * 
   * @param id
   *          int che rappresenta l'identificativo del Progetto Formativo
   * @param azienda
   *          Azienda che rappresenta l'Azienda coinvolta nel Progetto Formativo
   * @param segreteria
   ...
   * @param obiettivi
   *          String che raprresenta gli obiettivi del Progetto Formativo
   * @param dataFine
   *          String che raprresenta la data di fine del Progetto Formativo
   * @param convalidaProf
   *          boolean che rappresenta l'approvazione del Progetto Formativo da parte del Professore
   * @param convalidaSegr
   *          boolean che rappresenta l'approvazione del Progetto Formativo da parte della
   *          Segreteria
   * @param sottoscrizioneStu
   *          boolean che rappresenta la sottoscrizione al Progetto Formaitvo da parte dello
   *          Studente
   * 
   * @author Iannuzzi Nicolà
   */
  public ProgettoFormativo(int id, Azienda azienda, Segreteria segreteria, Studente studente,
      Professore professore, String dataInizio, String obiettivi, String dataFine,
      boolean convalidaProf, boolean convalidaSegr, boolean sottoscrizioneStu) {
    this.id = id;
   ...
   * 
   * @param azienda
   *          String che rappresenta l'Azienda coinvolta nel Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param segreteria
   *          String che rappresenta la Segreteria coinvolta nel Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param studente
   *          String che rappresenta lo Studente che effettua il Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param professore
   *          String che rappresenta il Professore del Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param obiettivi
   *          String che rappresenta gli obiettivi del Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param dataFine
   *          String che rappresenta la data di fine del Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param convalidaProf
   *          boolean che rappresenta se il professore ha convalidato il Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param convalidaSegr
   *          boolean che rappresenta se la Segretera ha convalidato il Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param sottoscrizioneStu
   *          boolean che rappresenta se lo Studente ha sottoscritto il Progetto Formativo
   * 
   * @author Iannuzzi Nicolà
   */
  ...
  /**
   * Permette di definire una stringa che può essere considerata come la "rappresentazione
   * testuale" dell'oggetto ProgettoFormativo.
   * 
  ...
  public String toString() {
    return "ProgettoFormativo [id=" + id + ", azienda=" + azienda + ", segreteria=" + segreteria
        + ", studente=" + studente + ", dataInizio=" + dataInizio + ", obiettivi=" + obiettivi
        + ", dataFine=" + dataFine + ", convalidaProf=" + convalidaProf + ", convalidaSegr="
        + convalidaSegr + ", sottoscrizioneStu=" + sottoscrizioneStu + "]";
  }
