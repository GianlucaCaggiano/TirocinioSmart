...
public class RichiestaTirocinio {
   ...
   * 
   * @param id
   *          Identificativo che contrassegna la richiesta di tirocinio
   * @param azienda
   *          Azienda che rappresenta l'azienda coinvolta nella Richiesta Tirocinio
   * @param professore
   *          Professore che rappresenta il professore coinvolto nella Richiesta Tirocinio
   * @param convalidaAzienda
   *          boolean che rappresenta la convalida dell'Azienda nella Richiesta Tirocinio
   * @param convalidaProf
   *          boolean che rappresenta la convalida del Professore nella Richiesta Tirocinio
   * 
   * @author Iannuzzi Nicolà
   */
  public RichiestaTirocinio(int id, Azienda azienda, Professore professore,
      boolean convalidaAzienda, boolean convalidaProf) {
    this.id = id;
   ...
   * testuale" dell'oggetto RichiestaTirocinio.
   * 
  ...
  public boolean equals(Object object) {
    ...
    return (richiestaTirocinio.getAzienda().equals(this.azienda)
        && richiestaTirocinio.getProfessore().equals(this.professore)
        && richiestaTirocinio.isConvalidaAzienda() == this.isConvalidaAzienda()
        && richiestaTirocinio.isConvalidaProf() == this.convalidaProf);
  }
