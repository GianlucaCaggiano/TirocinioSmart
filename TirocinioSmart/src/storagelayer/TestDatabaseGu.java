...
/**
 * Classe per i test di unit� DatabaseGU.
 * 
...
public class TestDatabaseGu {
  ...
  public void testGetUtenteById() {
    // Testa il caso in cui l'utente non � presente nel database
  ...
  public void testDoRetriveAllNonAbilitatiAziende() {
    ...
    try {
      ...
      for (int i = 0; i < test.size(); i++) {
        //Testa il caso in cui l'oggetto passato al metodo equals � null
        assertFalse(test.get(i).equals(null));
        //Testa il caso in cui l'oggetto passato al metodo equals � di un'altra classe
        Utente s = new Studente();
        assertFalse(test.get(i).equals(s));
        //Testa il caso in cui l'oggetto passato al metodo equals � uguale
