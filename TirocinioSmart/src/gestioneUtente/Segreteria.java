...
public class Segreteria extends Utente
{
	 ...
	 * 
	 * @param user String che rappresenta la Segreteria nonchè user di accesso alla piattaforma
	 * @param password String che rappresenta la chiave di accesso alla piattaforma per la Segreteria
	 * @param Nome String che rappresenta il nome dell'adetto della Segreteria
	 * @param Cognome String che rappresenta il cognome dell'adetto della Segreteria
	 * @param telefono String che rappresenta il numero di telefono della Segreteria
	 * @param email String che rappresenta l'email della Segreteria
	 * 
	 * @author Iannuzzi Nicolà
	 */
	public Segreteria(String user, String password, String Nome, String Cognome, String telefono, String email)
	{
	...
	* "rappresentazione testuale" dell'oggetto Segreteria.
	* 
