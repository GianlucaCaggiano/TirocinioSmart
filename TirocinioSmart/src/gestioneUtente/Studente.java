...
public class Studente extends Utente
{
	 ...
	 * @param email Stringa che rappresenta la mail dello studente, nonch� la user di accesso al sistema per tale utente
	...
	/**
	 * Serve per verificare se lo studente � abilitato o meno
	 *  
	 ...
	 * 
	 * @param abilitato valore booleano che rappresenta se lo studente � abilitato o meno
	 * 
	 * @author Caggiano Gianluca
	 */
