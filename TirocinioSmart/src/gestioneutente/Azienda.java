...
public class Azienda extends Utente {
   ...
   * 
   * @param email
   *          String che rappresenta l'email dell'azienda nonchè la user di accesso.
   * @param password
   *          String che rappresenta la password dell'azienda per l'accesso.
   * @param nome
   *          String che rappresenta il nome del Tutor Aziendale.
   * @param cognome
   *          String che rappresenta il cognome del Tutor Aziendale.
   * @param luogonascita
   *          String che rappresenta il luogo di nascita dell'Azienda.
   * @param datanascita
   *          String che rappresenta la data di nascita dell'Azienda.
   * @param denominazione
   *          String che rapprresenta la ragione sociale dell'Azienda
   * @param citta
   *          String che rappresenta la città dell'Azienda.
   * @param cap
   *          String che rappresenta il CAP dell'Azienda.
   * @param via
   *          String che rappresenta la via dell'Azienda.
   * @param abilitato
   *          boolean che rappresenta l'abilitazione dell'Azienda per il Tirocinio.
   * 
   * @author Iannuzzi Nicolà
   */
  public Azienda(String email, String password, String nome, String cognome, String luogonascita,
      String datanascita, String denominazione, String citta, String cap, String via,
      boolean abilitato) {
   ...
   * 
   * @param denominazione
   *          String che rappresenta la ragione sociale dell'Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param cap
   *          String che rappresenta il cap della Cità dell'Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param tipo
   *          String che rappresenta il tipo di Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param telefono
   *          String che rappresenta il numero di telefono dell'Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param chiSiamo
   *          String che rappresenta una descrizione dell'Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param sitoWeb
   *          String che rappresenta il sito web dell'Azienda
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param convenzione
   *          Convenzione che rappresenta la convenzione dell'Azienda con l'università
   * 
   * @author Iannuzzi Nicolà
   */
  ...
  public String toString() {
    return super.toString() + "Azienda [luogoNascita=" + luogoNascita + ", dataNascita="
        + dataNascita + ", denominazione=" + denominazione + ", citta=" + citta + ", CAP=" + cap
        + ", via=" + via + ", tipo=" + tipo + ", telefono=" + telefono + ", chiSiamo=" + chiSiamo
        + ", sitoWeb=" + sitoWeb + ", convenzione=" + convenzione + ", abilitato=" + abilitato
        + "]";
  }
