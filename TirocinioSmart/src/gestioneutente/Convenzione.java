...
public class Convenzione {
   ...
   * 
   * @param id
   *          int identificativo Convenzione
   * @param data
   *          String specifica la data della convenzione
   * @param specifica
   *          String che specifica una breve descrizione.
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param id
   *          Int che rappresenta l'id della convenzione
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * 
   * @param data
   *          String che rappresenta la data in cui è stata stipulata la convenzione
   * 
   * @author Iannuzzi Nicolà
   */
  ...
  /**
   * Determina se due oggetti rappresentano la stessa convenzione confrontandole alle convenzioni
   * suddette.
   * 
