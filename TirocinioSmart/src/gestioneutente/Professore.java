...
public class Professore extends Utente {
   ...
   * 
   * @param email
   *          String che rappresenta l'email del Professore nonchè la user di accesso
   * @param password
   *          String che rappresenta la password del Professore per l'accesso
   * @param nome
   *          String che rappresenta il nome del Professore
   * @param cognome
   *          String che rappresenta il cognome del Professore
   * @param autorizzo
   *          boolean che rappresental abilitazione del Professore per il Tirocinio
   * @param materia
   *          String che rappresenta la materia di insegnimento del Professore
   * 
   * @author Iannuzzi Nicolà
   */
  public Professore(String email, String password, String nome, String cognome, boolean autorizzo,
      String materia) {
   ...
   * 
   * @param autorizzo
   *          boolean che rappresenta se il Professore è abilitato per il Tirocinio
   * 
   * @author Iannuzzi Nicolà
   */
   ...
   * testuale" dell'oggetto Professore.
   * 
