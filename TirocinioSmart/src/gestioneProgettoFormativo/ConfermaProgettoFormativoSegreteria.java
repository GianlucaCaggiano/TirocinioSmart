...
/**
 * Servlet implementation class ConfermaProgettoFormativoSegreteria.
 * Gestisce l'update di un ConvalidaSegr in ProgettoFormativo
 * 
...
public class ConfermaProgettoFormativoSegreteria extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/ConfermaProgettoFormativoSegreteria.jsp");
