...
<body>
	...
	<%
		...
		array = DatabasePf.doRetrievProgettoFormativoSegreteria(segreteria.getUser());
	%>
	...
	<% 	} else {%>
				...
				<%for(ProgettoFormativo progettoFormativo: array) 
				  {%>
				    ...
				    <th class="btn-right"><a href="ConfermaProgettoFormativoSegreteria?id=<%=progettoFormativo.getId()%>">Conferma</a></th>
				  </tr>
				  <%} %>
			</table>
			<%} %>
